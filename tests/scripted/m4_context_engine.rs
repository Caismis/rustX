...
/// Planning applies the correction to the summary input budget: a
/// compaction recovering from an overflow may not assemble a summary request
/// the same estimator would have called safe.
#[test]
fn an_estimate_correction_tightens_the_summary_input_budget() {
