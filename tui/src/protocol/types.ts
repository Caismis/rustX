 ...
 * - Runtime Client event discriminators are a closed vocabulary at
...
export type ToolCancellationPhase = "before_start" | "during_execution";
...
/**
 * Checks only the discriminator of one Runtime Client event.
 *
 ...
 * may receive the event as a known fact.
 */
 ...
 *
 * A known notification carries a cursor and a known event discriminator.
