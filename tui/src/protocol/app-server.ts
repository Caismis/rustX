 ...
 * from `protocol/app-server/v3.ts` — generated from the authoritative Rust DTOs
 ...
 *        | schemars
 * protocol/app-server/v3.schema.json
 *        | json-schema-to-typescript
 * protocol/app-server/v3.ts       (generated)
...
import type {
  ...
  Success,
} from "../../../protocol/app-server/v3.ts";
...
export type SessionSummaryView = SessionSummary & {
  residency?: import("../../../protocol/app-server/v3.ts").ResidencyState;
  activeRoot?: boolean;
};
