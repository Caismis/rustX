 ...
 * from `protocol/app-server/v16.ts` — generated from the authoritative Rust DTOs
 ...
 *        | schemars
 * protocol/app-server/v16.schema.json
 *        | json-schema-to-typescript
 * protocol/app-server/v16.ts       (generated)
...
import type {
  ...
  Success,
} from "../../../protocol/app-server/v16.ts";
