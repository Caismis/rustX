 ...
 * from `protocol/app-server/v2.ts` — generated from the authoritative Rust DTOs
 ...
 *        | schemars
 * protocol/app-server/v2.schema.json
 *        | json-schema-to-typescript
 * protocol/app-server/v2.ts       (generated)
...
import type {
  ...
  Success,
} from "../../../protocol/app-server/v2.ts";
...
export type SessionSummaryView = SessionSummary & {
  residency?: import("../../../protocol/app-server/v2.ts").ResidencyState;
  activeRoot?: boolean;
};
