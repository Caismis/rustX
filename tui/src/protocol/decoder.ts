/** The sole untrusted-JSON → generated DTO boundary for App Server v7. */
import { readFileSync } from "node:fs";
import { Ajv2020 } from "ajv/dist/2020.js";
import { fullFormats } from "ajv-formats/dist/formats.js";
import type { ProtocolMessage } from "../../../protocol/app-server/v7.ts";

const schema = JSON.parse(readFileSync(
  new URL("../../../protocol/app-server/v7.schema.json", import.meta.url),
  "utf8",
));
