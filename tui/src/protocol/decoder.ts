/** The sole untrusted-JSON → generated DTO boundary for App Server v23. */
import { readFileSync } from "node:fs";
import { Ajv2020 } from "ajv/dist/2020.js";
import { fullFormats } from "ajv-formats/dist/formats.js";
import type { ProtocolMessage } from "../../../protocol/app-server/v23.ts";

const schema = JSON.parse(readFileSync(
  new URL("../../../protocol/app-server/v23.schema.json", import.meta.url),
  "utf8",
));
