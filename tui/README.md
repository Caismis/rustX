...
App Server protocol v2. Source availability also distinguishes inert decisions and enabled/unprepared sources. Parallel branches and Loop iterations retain concrete identities;
...
Both modes use the same typed client and generated v2 DTOs. `--user-settings`,
...
bind stdio child or external WebSocket
  -> initialize (App Server protocol v2)
