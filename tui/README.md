...
App Server protocol v22. Source availability also distinguishes inert decisions and enabled/unprepared sources. Parallel branches and Loop iterations retain concrete identities;
...
bind stdio child or external WebSocket
  -> initialize (App Server protocol v22)
