...
The JSON fixtures are also roundtripped by Rust's Runtime Client DTO test.
Preview exposes identity, revision, bounded name and ownership counts. Pending and
uncertain results carry only identity/status. Frozen cleanup records and scopes
remain internal to native Session recovery.
