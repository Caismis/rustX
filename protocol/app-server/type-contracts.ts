...
import type {MessageBlock, UserContentBlock, RuntimeClientSnapshot} from './v15.js';
...
// Native response projections and explicit cut side are the mandatory v15 contract.
import type {CompletedResponseView, Request1} from './v15.js';
const completed = {
