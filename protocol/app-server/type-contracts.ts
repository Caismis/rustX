...
import type {MessageBlock, UserContentBlock, RuntimeClientSnapshot} from './v20.js';
...
// Native response projections and explicit cut side are the mandatory v20 contract.
import type {CompletedResponseView, Request1} from './v20.js';
const completed = {
