...
import type {MessageBlock, UserContentBlock, RuntimeClientSnapshot} from './v16.js';
...
// Native response projections and explicit cut side are the mandatory v16 contract.
import type {CompletedResponseView, Request1} from './v16.js';
const completed = {
