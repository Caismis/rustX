...
import type {MessageBlock, UserContentBlock, RuntimeClientSnapshot} from './v11.js';
...
// Native response projections and explicit cut side are the mandatory v11 contract.
import type {CompletedResponseView, Request1} from './v11.js';
const completed = {
