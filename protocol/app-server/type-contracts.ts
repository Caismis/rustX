...
import type {MessageBlock, UserContentBlock, RuntimeClientSnapshot} from './v22.js';
...
// Native response projections and explicit cut side are the mandatory v22 contract.
import type {CompletedResponseView, Request1} from './v22.js';
const completed = {
