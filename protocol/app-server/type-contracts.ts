...
import type {MessageBlock, UserContentBlock, RuntimeClientSnapshot} from './v12.js';
...
// Native response projections and explicit cut side are the mandatory v12 contract.
import type {CompletedResponseView, Request1} from './v12.js';
const completed = {
