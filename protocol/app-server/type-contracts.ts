...
import type {MessageBlock, UserContentBlock, RuntimeClientSnapshot} from './v19.js';
...
// Native response projections and explicit cut side are the mandatory v19 contract.
import type {CompletedResponseView, Request1} from './v19.js';
const completed = {
