...
const schema = JSON.parse(await readFile(new URL('v19.schema.json', import.meta.url), 'utf8'));
// Schemars emits draft-2020-12 $ref siblings for internally tagged newtypes.
// v19's ref resolver merges (and overwrites) their `properties`, losing the
...
const types = await compile(normalizeRefSiblings(schema), 'ProtocolMessage', {
  ...
  // Schemars closes flattened envelopes with unevaluatedProperties. v19 does
...
await writeFile(new URL('v19.ts', import.meta.url), types);
...
await writeFile(new URL('fixtures.ts', import.meta.url),
  "// Generated from serialized Rust DTOs.\nimport type {ProtocolMessage} from './v19.js';\n" +
