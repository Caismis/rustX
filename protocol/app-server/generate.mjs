...
const schema = JSON.parse(await readFile(new URL('v8.schema.json', import.meta.url), 'utf8'));
...
await writeFile(new URL('v8.ts', import.meta.url), types);
...
await writeFile(new URL('fixtures.ts', import.meta.url),
  "// Generated from serialized Rust DTOs.\nimport type {ProtocolMessage} from './v8.js';\n" +
