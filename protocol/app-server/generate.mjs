...
const schema = JSON.parse(await readFile(new URL('v15.schema.json', import.meta.url), 'utf8'));
...
await writeFile(new URL('v15.ts', import.meta.url), types);
...
await writeFile(new URL('fixtures.ts', import.meta.url),
  "// Generated from serialized Rust DTOs.\nimport type {ProtocolMessage} from './v15.js';\n" +
