...
const schema = JSON.parse(await readFile(new URL('v9.schema.json', import.meta.url), 'utf8'));
...
await writeFile(new URL('v9.ts', import.meta.url), types);
...
await writeFile(new URL('fixtures.ts', import.meta.url),
  "// Generated from serialized Rust DTOs.\nimport type {ProtocolMessage} from './v9.js';\n" +
