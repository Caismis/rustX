...
const schema = JSON.parse(await readFile(new URL('v21.schema.json', import.meta.url), 'utf8'));
...
await writeFile(new URL('v21.ts', import.meta.url), types);
...
await writeFile(new URL('fixtures.ts', import.meta.url),
  "// Generated from serialized Rust DTOs.\nimport type {ProtocolMessage} from './v21.js';\n" +
