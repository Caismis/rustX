...
//!   deadline, measured through an injected [`MonotonicClock`]; later
...
mod tests {
    ...
    use super::{CoalescePolicy, PublicationCoalescer};
    ...
    use crate::runtime::{ManualMonotonicClock, MonotonicClock};
