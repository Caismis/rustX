...
/// The closed allowlist of provider-neutral request options Trace exposes.
///
...
/// mean projecting whatever an operator put there, so Trace instead names
...
const REQUEST_OPTION_ALLOWLIST: &[&str] = &[
    "frequency_penalty",
    "logit_bias",
    "logprobs",
    "min_p",
