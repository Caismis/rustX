//! The Runtime Client snapshot read model (Runtime Client Protocol v6).
//!
...
/// runtime owner. The shape belongs to Runtime Client Protocol v6: internal
...
/// container shape belongs to Runtime Client Protocol v6 while the
