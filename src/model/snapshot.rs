...
pub use crate::context::contribution::ContributionStart;
...
pub struct RequestSnapshot {
    ...
    /// Frozen accepted contributions visible in this actual request.
    pub contributions: Vec<ContributionStart>,
}
