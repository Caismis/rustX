...
mandatory protocol is **v13**. `rustx.app-server.v13` is the only WebSocket
...
- Generated `protocol/app-server/v13.ts`, `v13.schema.json`, `fixtures.ts`, `fixtures.json`; removed v7 files under the single-current-version convention.
...
cannot be overridden by durable recovery. Runtime Client v40, App Server v13 and
...
cleanup-recovery caller; its behavior remains unchanged. App Server v13 and Runtime
...
No backend or protocol changes were made: App Server v13 and Runtime Client v40,
