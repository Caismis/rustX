# CFG3 Workflow admission regressions
...
| Exact child Tool and unavailable ToolSource diagnostics disable Workflows, and selected Agent requirements fail admission | `cfg274_missing_role_and_required_child_exact_tool_disable_instead_of_suppression` |
...
| User/Workspace Skill identities shadow as complete resources; absent or invalid required Skills disable | `cfg274_child_skills_use_merged_catalog_explicitly_and_remain_lazy`; real Skill loss/recovery publication test |
...
| Present dimensions replace whole defaults | `cfg274_replacements_remove_entire_defaults_and_known_goal_disables_child`, including empty tools/skills/plugins and omitted Goal dimension |
