...
App Server v20 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v20`. `session/upload` replaces the old user carrier. `artifact/read`
