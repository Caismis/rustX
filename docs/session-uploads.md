...
App Server v23 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v23`. `session/upload` replaces the old user carrier. `artifact/read`
