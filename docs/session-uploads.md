...
App Server v21 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v21`. `session/upload` replaces the old user carrier. `artifact/read`
