...
App Server v13 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v13`. `session/upload` replaces the old user carrier. `artifact/read`
