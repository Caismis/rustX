...
App Server v11 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v11`. `session/upload` replaces the old user carrier. `artifact/read`
