...
App Server v12 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v12`. `session/upload` replaces the old user carrier. `artifact/read`
