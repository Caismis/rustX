...
App Server v17 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v17`. `session/upload` replaces the old user carrier. `artifact/read`
