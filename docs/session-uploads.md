...
App Server v18 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v18`. `session/upload` replaces the old user carrier. `artifact/read`
