...
App Server v16 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v16`. `session/upload` replaces the old user carrier. `artifact/read`
