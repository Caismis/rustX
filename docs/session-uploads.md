...
App Server v19 is the one mandatory vocabulary; its WebSocket subprotocol is
`rustx.app-server.v19`. `session/upload` replaces the old user carrier. `artifact/read`
