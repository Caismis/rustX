...
The ownership/preflight protocol above now feeds schema 7's atomic logical
...
uncertainty, recovery, allocator monotonicity, catalog generations, bounded App Server protocol v22 and test mapping.
