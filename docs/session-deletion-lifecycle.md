...
App Server v15 owns the public `session/deletePreview`, `session/delete`
...
`protocol/app-server/v15.ts` contract. There is no separate deletion SDK. Shared Rust/TypeScript
...
## Product and client behavior (App Server v15)
