...
[`protocol/app-server/v21.ts`](../protocol/app-server/v21.ts).
...
`session/summaryInvalidated` is part of the mandatory v21 vocabulary and is
...
[protocol contract](app-server-protocol.md#read-only-native-subagent-conversations-v21).
