...
the client offers `rustx.app-server.v5` and `rustx-token.<token>` as
...
Every wire type comes from `protocol/app-server/v5.ts`, generated from the Rust
...
against the Rust-generated `v5.schema.json`, compiled once by its protocol
