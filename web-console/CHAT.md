...
The mandatory App Server vocabulary is v13 (`rustx.app-server.v13` and generated
`protocol/app-server/v13.ts` / `v13.schema.json`). v12 and earlier initialization and
...
App Server v13, Runtime Client v43, SQLite v42, and Session catalog v12, with no
