...
The mandatory App Server vocabulary is v17 (`rustx.app-server.v17` and generated
`protocol/app-server/v17.ts` / `v17.schema.json`). v12 and earlier initialization and
...
App Server v17, Runtime Client v44, SQLite v42, and Session catalog v12, with no
