...
The mandatory App Server vocabulary is v16 (`rustx.app-server.v16` and generated
`protocol/app-server/v16.ts` / `v16.schema.json`). v12 and earlier initialization and
...
App Server v16, Runtime Client v44, SQLite v42, and Session catalog v12, with no
