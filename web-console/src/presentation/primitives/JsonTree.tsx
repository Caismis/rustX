/* Copyright (c) 2026 DeepSeek. MIT. Derived from pinned Harness ui-primitives/src/JsonTree.tsx; see PROVENANCE.md. */
...
export function JsonTree({
  ...
  // React 19 requires an explicit initial value for a mutable ref.
