...
/** Bounded Shiki core: TS/JS, shell and JSON at boot; Rust/Python lazy.
 * Unknown languages remain plain. Completed lines retain grammar state and tokens.
 * No workspace, editor, file-extension service or runtime registry is imported.
 */
 ...
 * trade to keep the boot set to one JS-family grammar. Rust/Python load lazily through {@link LAZY_GRAMMARS}.
 */
const LANGS = [langTs, langBash, langJson]

/** Explicit optional grammars; each stays out of the initial browser chunk. */
