...
export function RightPanel({ open, close, width, canShow, title, children }: {
  open: boolean; close: () => void; width: number; canShow: boolean; title: string; children: ReactNode;
}) {
