import type { GoalSnapshot, RuntimeClientSnapshot, TodoTask, UserContentBlock } from '../../../protocol/app-server/v3';
...
/** Presentation-only one-line summary of submitted content. */
export function contentPreview(content: readonly UserContentBlock[]): string {
