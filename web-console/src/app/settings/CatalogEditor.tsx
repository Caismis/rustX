...
import { UnitForm, TextField } from './controls';
...
export function CatalogEditor({ source, scope, revision }: { source: SourceSettings; scope: SourceScope; revision: string }) {
