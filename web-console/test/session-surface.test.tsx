...
import type { RuntimeClientSnapshot, RuntimeClientSessionDeletionResult } from '../../protocol/app-server/v24';
...
function freeze(request: import('../../protocol/app-server/v24').Request) { server.commit(request); return request; }
