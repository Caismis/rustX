...
import type { RuntimeClientSnapshot, RuntimeClientSessionDeletionResult } from '../../protocol/app-server/v25';
...
function freeze(request: import('../../protocol/app-server/v25').Request) { server.commit(request); return request; }
