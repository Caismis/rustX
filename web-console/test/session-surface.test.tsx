...
import type { RuntimeClientSnapshot, RuntimeClientSessionDeletionResult } from '../../protocol/app-server/v20';
...
function freeze(request: import('../../protocol/app-server/v20').Request) { server.commit(request); return request; }
