...
async function failedSessionConfiguration(sources: readonly import('../../protocol/app-server/v25').SourceTarget[], host = hostFixture()) {
  server.handlers.set('session/settings', () => ({ type: 'settings', revision: '0', settings: { cwd: '/workspace/A' } }));
...
// navigation decision.
async function pendingOwnershipLookup(sources: readonly import('../../protocol/app-server/v25').SourceTarget[]) {
